                ...
                <div style="font-size:12pt;font-family:Arial, sans-serif;">
                    ...
                    <div style="display:flex; flex-flow: column nowrap;">
                        <div style="display:flex; flex-flow: row nowrap;text-align:left;font-family:Arial, sans-serif;font-size:9pt">
                            ...
                            <p style="flex: 1 1 0;">&delta;<sub>y</sub> = {Math.Round(instantDeflection * 1000)} mm</p>
                        </div>
                        <div style="display:flex; flex-flow: row nowrap;text-align:left;font-family:Arial, sans-serif;font-size:9pt">
                            <p style="flex: 1 1 0;">Final deflection with creep</p>
                            <p style="flex: 1 1 0;">&delta;<sub>y,Final</sub> = &delta;<sub>y</sub> x (1 + k<sub>def</sub>) = {Math.Round(finalDeflection * 1000)} mm</p>
                        </div>
                        <div style="display:flex; flex-flow: row nowrap;text-align:left;font-family:Arial, sans-serif;font-size:9pt">
                            <p style="flex: 1 1 0;">Allowable deflection</p>
                            <p style="flex: 1 1 0;">&delta;<sub>y,Allowable</sub> = L / {limitRatio} = {Math.Round(deflectionLimit * 1000)} mm</p>
                        </div>
                        <div style="display:flex; flex-flow: row nowrap;text-align:left;font-family:Arial, sans-serif;font-size:9pt">
                            <p style="flex: 1 1 0;"> </p>
                            <p style="flex: 1 1 0;">&delta;<sub>y,Final</sub> / &delta;<sub>y,Allowable</sub> = {Math.Round(finalDeflection / deflectionLimit * 1000) / 1000}</p>
                        </div>
                ...
                <div style="font-size:12pt;font-family:Arial, sans-serif;">
                    ...
                    <div style="display:flex; flex-flow: column nowrap;">
                        ...
                        <div style="display:flex; flex-flow: row nowrap;text-align:left;font-family:Arial, sans-serif;font-size:9pt">
                            ...
                            <p style="flex: 1 1 0;">(&sigma;<sub>m,y,d</sub> / (k<sub>crit</sub> x f<sub>m,y,d</sub>))<sup>2</sup> + &sigma;<sub>c,0,d</sub> / (k<sub>c,z</sub> x f<sub>c,0,d</sub>) = {Math.Round(stabilityCheck * 1000) / 1000}</p>
                        </div>
                        <p style="text-align:right; font-style:italic; font-size:9pt;"><strong><em>{designMessage}</em></strong></p>
                    </div>
                </div>
                    ...
                    <div style="font-size:12pt;font-family:Arial, sans-serif;">
                        ...
                        <div style="display:flex; flex-flow: column nowrap;">
                            ...
                            <div style="display:flex; flex-flow: row nowrap;text-align:left;font-family:Arial, sans-serif;font-size:9pt">
                                ...
                                <p style="flex: 1 1 0;">&lambda;<sub>y</sub> = L<sub>e,y</sub> / i<sub>y</sub> = {Math.Round(slendernessMajor * 1000) / 1000}</p>
                            </div>
                            <div style="display:flex; flex-flow: row nowrap;text-align:left;font-family:Arial, sans-serif;font-size:9pt">
                                <p style="flex: 1 1 0;">Relative slenderness ratio - exp 6.21</p>
                                <p style="flex: 1 1 0;">&lambda;<sub>rel,y</sub> = &lambda;<sub>y</sub> / π x √(f<sub>c,0,k</sub> / E<sub>0.05</sub>) = {Math.Round(relativeSlendernessMajor * 1000) / 1000}</p>
                            </div>
                            <div style="display:flex; flex-flow: row nowrap;text-align:left;font-family:Arial, sans-serif;font-size:9pt">
                            ...
                            <div style="display:flex; flex-flow: row nowrap;text-align:left;font-family:Arial, sans-serif;font-size:9pt">
                                <p style="flex: 1 1 0;">Slenderness ratio</p>
                                <p style="flex: 1 1 0;">&lambda;<sub>z</sub> = L<sub>e,z</sub> / i<sub>z</sub> = {Math.Round(slendernessMinor * 1000) / 1000}</p>
                            </div>
                            <div style="display:flex; flex-flow: row nowrap;text-align:left;font-family:Arial, sans-serif;font-size:9pt">
                                <p style="flex: 1 1 0;">Relative slenderness ratio - exp 6.22</p>
                                <p style="flex: 1 1 0;">&lambda;<sub>rel,z</sub> = &lambda;<sub>z</sub> / π x √(f<sub>c,0,k</sub> / E<sub>0.05</sub>) = {Math.Round(relativeSlendernessMinor * 1000) / 1000}</p>
                            </div>
                            <p style="text-align:right; font-style:italic; font-size:9pt;"><strong><em>Both &lambda;<sub>rel,y</sub> and &lambda;<sub>rel,z</sub> ≤ 0.3, column stability check not required</em></strong></p>
                        </div>
                    </div>
                """;
            ...
            string teddsCalcHtml = $"""
                    <div style="font-size:12pt;font-family:Arial, sans-serif;">
                        ...
                        <div style="display:flex; flex-flow: column nowrap;">
                            ...
                            <p style="text-align:right; font-style:italic; font-size:9pt;"><strong><em>&lambda;<sub>rel,y</sub> > 0.3, column stability check is required</em></strong></p>
                            <div style="display:flex; flex-flow: row nowrap;text-align:left;font-family:Arial, sans-serif;font-size:9pt">
                                <p style="flex: 1 1 0;">Slenderness factor</p>
                                <p style="flex: 1 1 0;">&beta;<sub>c</sub> = {beta_c}</p>
                            </div>
                            <div style="display:flex; flex-flow: row nowrap;text-align:left;font-family:Arial, sans-serif;font-size:9pt">
                                <p style="flex: 1 1 0;">Instability factors - exp 6.25, 6.26, 6.27, & 6.28</p>
                                <p style="flex: 1 1 0;">k<sub>y</sub> = 0.5 x (1 + &beta;<sub>c</sub> x (&lambda;<sub>rel,y</sub> - 0.3) + &lambda;<sub>rel,y</sub><sup>2</sup>) = {Math.Round(k_y * 1000) / 1000}</p>
                            </div>
                            <div style="display:flex; flex-flow: row nowrap;text-align:left;font-family:Arial, sans-serif;font-size:9pt">
                                <p style="flex: 1 1 0;"> </p>
                                <p style="flex: 1 1 0;">k<sub>z</sub> = 0.5 x (1 + &beta;<sub>c</sub> x (&lambda;<sub>rel,z</sub> - 0.3) + &lambda;<sub>rel,z</sub><sup>2</sup>) = {Math.Round(k_z * 1000) / 1000}</p>
                            </div>
                            <div style="display:flex; flex-flow: row nowrap;text-align:left;font-family:Arial, sans-serif;font-size:9pt">
                                <p style="flex: 1 1 0;"> </p>
                                <p style="flex: 1 1 0;">k<sub>c,y</sub> = 1 / (k<sub>y</sub> + √(k<sub>y</sub><sup>2</sup> - &lambda;<sub>rel,y</sub><sup>2</sup>)) = {Math.Round(k_cy * 1000) / 1000}</p>
                            </div>
                            <div style="display:flex; flex-flow: row nowrap;text-align:left;font-family:Arial, sans-serif;font-size:9pt">
                                <p style="flex: 1 1 0;"> </p>
                                <p style="flex: 1 1 0;">k<sub>c,z</sub> = 1 / (k<sub>z</sub> + √(k<sub>z</sub><sup>2</sup> - &lambda;<sub>rel,z</sub><sup>2</sup>)) = {Math.Round(k_cz * 1000) / 1000}</p>
                            </div>
                            <div style="display:flex; flex-flow: row nowrap;text-align:left;font-family:Arial, sans-serif;font-size:9pt">
                                <p style="flex: 1 1 0;">Column stability checks - exp 6.23 & 6.24</p>
                                <p style="flex: 1 1 0;">&sigma;<sub>c,0,d</sub> / (k<sub>c,y</sub> x f<sub>c,0,d</sub>) + &sigma;<sub>m,y,d</sub> / f<sub>m,y,d</sub> + k<sub>m</sub> x &sigma;<sub>m,z,d</sub> / f<sub>m,z,d</sub> = {Math.Round(stabilityCheckMajor * 1000) / 1000}</p>
                            </div>
                            <div style="display:flex; flex-flow: row nowrap;text-align:left;font-family:Arial, sans-serif;font-size:9pt">
                                <p style="flex: 1 1 0;"> </p>
                                <p style="flex: 1 1 0;">&sigma;<sub>c,0,d</sub> / (k<sub>c,z</sub> x f<sub>c,0,d</sub>) + k<sub>m</sub> x &sigma;<sub>m,y,d</sub> / f<sub>m,y,d</sub> + &sigma;<sub>m,z,d</sub> / f<sub>m,z,d</sub> = {Math.Round(stabilityCheckMinor * 1000) / 1000}</p>
                            </div>
                            <p style="text-align:right; font-style:italic; font-size:9pt;"><strong><em>{designMessage}</em></strong></p>
                        </div>
                    </div>
